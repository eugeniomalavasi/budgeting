    ...
    <div class="px">
      ...
      <div class="chart-card card">
        ...
        <div v-else class="month-table">
          ...
          <div v-for="m in months" :key="m.id" class="mt-row" :class="{ expanded: expandedMonth === m.id }"
      ...
      <div class="card cat-table">
        <div v-for="[cat, val] in topCatAll" :key="cat" class="cat-row">
          ...
          <span class="cat-bar-wrap">
            <div class="cat-bar"
              :style="{ width: (val / topCatAll[0][1] * 100) + '%', background: CAT_COLORS[cat] || '#94a3b8' }"></div>
          </span>
