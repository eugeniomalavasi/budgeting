        ...
        <div class="card list" :data-kind="grp.kind">
          <div v-for="c in orderedItems(grp)" :key="c.id" class="cat-row"
            ...
            <template v-else>
              ...
              <button class="mini-btn icon" @click="apriEdit(c)" aria-label="Modifica">
              ...
              <button class="mini-btn icon danger" @click="rimuovi(c)" aria-label="Elimina">
...
.mini-btn.icon { display: flex; align-items: center; justify-content: center; }
.mini-btn.icon svg { width: 19px; height: 19px; }
